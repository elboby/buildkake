...
class SvnAdapter extends Adapter
{
  ...
  public function download()
  {
    ...
    self::_system('svn checkout '.$this->url.' '.$this->full_path);
  }
  ...
  public function checkUpdateNeeded()
  {
    ...
    $rev_wc = self::_system('svn info '.$this->full_path.' | grep -i "Last Changed Rev"');
  ...
  public function update()
  {
    ...
    self::_system('svn update '.$this->full_path);
  }
}